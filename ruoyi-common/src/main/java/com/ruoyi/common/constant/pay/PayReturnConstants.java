...
public enum PayReturnConstants {
    ...
    PayReturnConstants(String code, String message) {
        this.code = code;
     ...
     * @return
     */
    public static PayReturnConstants getReturnEnum(String code) {
        if (code == null) {
            return null;
        }

        PayReturnConstants[] values = PayReturnConstants.values();
        for (PayReturnConstants e : values) {
