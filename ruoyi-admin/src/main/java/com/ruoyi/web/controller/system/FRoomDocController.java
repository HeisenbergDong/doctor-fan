...
public class FRoomDocController extends BaseController
{
    @Autowired
    private IFRoomDocService fRoomDocService;
    ...
    {
        startPage();
        List<FRoomDoc> list = fRoomDocService.selectFRoomDocList(fRoomDoc);
    ...
    {
        List<FRoomDoc> list = fRoomDocService.selectFRoomDocList(fRoomDoc);
        ExcelUtil<FRoomDoc> util = new ExcelUtil<FRoomDoc>(FRoomDoc.class);
    ...
    {
        return success(fRoomDocService.selectFRoomDocById(id));
    }
    ...
    {
        return toAjax(fRoomDocService.insertFRoomDoc(fRoomDoc));
    }
    ...
    {
        return toAjax(fRoomDocService.updateFRoomDoc(fRoomDoc));
    }
    ...
    {
        return toAjax(fRoomDocService.deleteFRoomDocByIds(ids));
    }
}
